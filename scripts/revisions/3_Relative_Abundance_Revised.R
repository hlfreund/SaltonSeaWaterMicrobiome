...
# #### Update Sample ID Name for Publication ####
# unique(b.fam_RA_meta$SampleID)
#
...
# b.fam_RA_meta$PlotID = gsub("8.24.21.","Aug 24, 2021 ",b.fam_RA_meta$PlotID)
# b.fam_RA_meta$PlotID = gsub("12.22.21.","Dec 22, 2021 ",b.fam_RA_meta$PlotID)
# b.fam_RA_meta$PlotID = gsub("4.13.22.","Apr 13, 2022 ",b.fam_RA_meta$PlotID)
# unique(b.fam_RA_meta$PlotID)
#
...
#
# meta_scaled$PlotID = gsub("^SSW.","",meta_scaled$SampleID)
# meta_scaled$PlotID = factor(meta_scaled$PlotID, levels=unique(meta_scaled$PlotID[order(meta_scaled$SampDate,meta_scaled$Depth_m)]), ordered=TRUE)
#
#
...
b.phyla_RA_meta$PlotID = gsub("8.24.21.","Aug 24, 2021 ",b.phyla_RA_meta$PlotID)
b.phyla_RA_meta$PlotID = gsub("12.22.21.","Dec 22, 2021 ",b.phyla_RA_meta$PlotID)
b.phyla_RA_meta$PlotID = gsub("4.13.22.","Apr 13, 2022 ",b.phyla_RA_meta$PlotID)
unique(b.phyla_RA_meta$PlotID)
...
b.phy_RA<-ggplot(b.phyla_RA_meta, aes(x=PlotID, y=Count, fill=Phylum))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  ...
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),
        axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),
        legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=2))+scale_y_continuous(expand = c(0,0)) + facet_wrap(vars(b.phyla_RA_meta$SampDate),scales="free")

ggsave(b.phy_RA,filename = "figures/Revised/RelativeAbundance/Phylum/16S_Phyla.RA_barplot.png", width=15, height=10, dpi=600)

ggplot(b.phyla_RA_meta[b.phyla_RA_meta$Count>0.05,], aes(x=PlotID, y=Count, fill=Phylum))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Phylum Relative Abundance", x="SampleID", y="Relative Abundance", fill="Phylum")+
...
ggsave(b.phy.a21_RA,filename = "figures/Revised/RelativeAbundance/Phylum/16S_August2021_Phyla.RA_barplot.png", width=12, height=10, dpi=600)
...
b.phy.d21_RA<-ggplot(dec.phy, aes(x=PlotID, y=Count, fill=Phylum))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  ...
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),
        legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=1))+scale_y_continuous(expand = c(0,0),limits = c(0,1))

ggsave(b.phy.d21_RA,filename = "figures/Revised/RelativeAbundance/Phylum/16S_December2021_Phyla.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.phy.a22_RA,filename = "figures/Revised/RelativeAbundance/Phylum/16S_April2022_Phyla.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(p.h1,filename = "figures/Revised/RelativeAbundance/Phylum/16S_Phyla.RA_heatmap.png", width=12, height=10, dpi=600)

b.fam_RA_meta[1:4,1:4]
...
ggsave(tp1,filename = "figures/Revised/RelativeAbundance/Phylum/SSW_16S_Phyla.RA_depth_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(tp1a,filename = "figures/Revised/RelativeAbundance/Phylum/SSW_16S_Phyla.RA_depth_taxasum_5percent.png", width=15, height=10, dpi=600)
...
ggsave(psd0,filename = "figures/Revised/RelativeAbundance/Phylum/16S_Phyla.RA_barplot_sampdate.png", width=12, height=10, dpi=600)
...
ggsave(psd1,filename = "figures/Revised/RelativeAbundance/Phylum/SSW_16S_Phyla.RA_date_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(psd1a,filename = "figures/Revised/RelativeAbundance/Phylum/SSW_16S_Phyla.RA_date_taxasum_5percent.png", width=15, height=10, dpi=600)
...
b.class_RA_meta$PlotID = gsub("8.24.21.","Aug 24, 2021 ",b.class_RA_meta$PlotID)
b.class_RA_meta$PlotID = gsub("12.22.21.","Dec 22, 2021 ",b.class_RA_meta$PlotID)
b.class_RA_meta$PlotID = gsub("4.13.22.","Apr 13, 2022 ",b.class_RA_meta$PlotID)
unique(b.class_RA_meta$PlotID)
...
ggsave(b.cls_RA,filename = "figures/Revised/RelativeAbundance/Class/16S_Class.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.cls.a21_RA,filename = "figures/Revised/RelativeAbundance/Class/16S_August2021_Classes.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.cls.d21_RA,filename = "figures/Revised/RelativeAbundance/Class/16S_December2021_Classes.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.cls.a22_RA,filename = "figures/Revised/RelativeAbundance/Class/16S_April2022_Classes.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(c.h1,filename = "figures/Revised/RelativeAbundance/Class/16S_class.RA_heatmap.png", width=12, height=10, dpi=600)
...
ggsave(cd1,filename = "figures/Revised/RelativeAbundance/Class/SSW_16S_class.RA_barplot_depth.png", width=12, height=10, dpi=600)
...
ggsave(cd1a,filename = "figures/Revised/RelativeAbundance/Class/SSW_16S_class.RA_barplot_depth_5percent.png", width=12, height=10, dpi=600)
...
ggsave(cd2,filename = "figures/Revised/RelativeAbundance/Class/SSW_16S_class.RA_depth_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(cd2a,filename = "figures/Revised/RelativeAbundance/Class/SSW_16S_class.RA_depth_5percent_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(csd1,filename = "figures/Revised/RelativeAbundance/Class/SSW_16S_class.RA_barplot_sampdate.png", width=12, height=10, dpi=600)
...
ggsave(csd1,filename = "figures/Revised/RelativeAbundance/Class/SSW_16S_class.RA_barplot_sampdate_5percent.png", width=12, height=10, dpi=600)
...
ggsave(csd2,filename = "figures/Revised/RelativeAbundance/Class/SSW_16S_class_RA_date_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(csd3,filename = "figures/Revised/RelativeAbundance/Class/SSW_16S_class.RA_date_taxasum_5percent.png", width=15, height=10, dpi=600)
...
b.ord_RA_meta$PlotID = gsub("8.24.21.","Aug 24, 2021 ",b.ord_RA_meta$PlotID)
b.ord_RA_meta$PlotID = gsub("12.22.21.","Dec 22, 2021 ",b.ord_RA_meta$PlotID)
b.ord_RA_meta$PlotID = gsub("4.13.22.","Apr 13, 2022 ",b.ord_RA_meta$PlotID)
unique(b.ord_RA_meta$PlotID)
...
ggsave(b.ord_RA,filename = "figures/Revised/RelativeAbundance/Order/16S_Order.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.ord.a21_RA,filename = "figures/Revised/RelativeAbundance/Order/16S_August2021_Orders.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.ord.d21_RA,filename = "figures/Revised/RelativeAbundance/Order/16S_December2021_Orders.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.ord.a22_RA,filename = "figures/Revised/RelativeAbundance/Order/16S_April2022_Orders.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(o.h1,filename = "figures/Revised/RelativeAbundance/Order/16S_order.RA_heatmap.png", width=12, height=10, dpi=600)
...
ggsave(od1,filename = "figures/Revised/RelativeAbundance/Order/SSW_16S_order.RA_barplot_depth.png", width=12, height=10, dpi=600)
...
ggsave(od1a,filename = "figures/Revised/RelativeAbundance/Order/SSW_16S_order.RA_barplot_depth_5percent.png", width=12, height=10, dpi=600)
...
ggsave(od2,filename = "figures/Revised/RelativeAbundance/Order/SSW_16S_order.RA_depth_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(od2a,filename = "figures/Revised/RelativeAbundance/Order/SSW_16S_order.RA_depth_5percent_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(osd1,filename = "figures/Revised/RelativeAbundance/Order/SSW_16S_order.RA_barplot_sampdate.png", width=12, height=10, dpi=600)
...
ggsave(osd1,filename = "figures/Revised/RelativeAbundance/Order/SSW_16S_order.RA_barplot_sampdate_5percent.png", width=12, height=10, dpi=600)
...
ggsave(osd2,filename = "figures/Revised/RelativeAbundance/Order/SSW_16S_order_RA_date_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(osd3,filename = "figures/Revised/RelativeAbundance/Order/SSW_16S_order.RA_date_taxasum_5percent.png", width=15, height=10, dpi=600)
...
b.fam_RA_meta.f1<-subset(b.fam_RA_meta, b.fam_RA_meta$Family!="Unknown") # drop unknown genera so they don't skew analyses
b.fam_RA_meta.f<-subset(b.fam_RA_meta.f1, b.fam_RA_meta.f1$Family!="Unknown Family") # drop unknown genera so they don't skew analyses
"Unknown Family" %in% b.fam_RA_meta.f
...
ggsave(b.fam_RA,filename = "figures/Revised/RelativeAbundance/Family/16S_fam.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.fam.a21_RA,filename = "figures/Revised/RelativeAbundance/Family/16S_August2021_Families.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.fam.d21_RA,filename = "figures/Revised/RelativeAbundance/Family/16S_December2021_Families.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.fam.a22_RA,filename = "figures/Revised/RelativeAbundance/Family/16S_April2022_Families.RA_barplot.png", width=12, height=10, dpi=600)
...
ggsave(f.h1,filename = "figures/Revised/RelativeAbundance/Family/16S_fam.RA_heatmap.png", width=12, height=10, dpi=600)

b.fam_RA_meta.f[1:4,1:4]

# # by Family + depth
# bac.fam.dep <- as.data.frame(dcast(b.fam_RA_meta,Depth_m~Family, value.var="Count", fun.aggregate=sum)) ###
...
# #+ scale_x_discrete(labels=c("August.2021"="August 2021","December.2021"="December 2021","April.2022"="April 2022"))
#
# ggsave(fd1,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_fam.RA_barplot_depth.png", width=12, height=10, dpi=600)
#
...
# #+ scale_x_discrete(labels=c("August.2021"="August 2021","December.2021"="December 2021","April.2022"="April 2022"))
#
# ggsave(fd1a,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_fam.RA_barplot_depth_5percent.png", width=12, height=10, dpi=600)
#
# # Taxonomic Summary by Depth
#
...
#
# ggsave(fd2,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_fam.RA_depth_taxasum.png", width=15, height=10, dpi=600)
#
...
#   labs(x="Microbial Family", y="Relative Abundance", title="Microbial Families & Depth",color="Depth (m)")
#
# ggsave(fd2a,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_fam.RA_depth_5percent_taxasum.png", width=15, height=10, dpi=600)

# by Family + Sampling Date
bac.fam.date <- as.data.frame(dcast(b.fam_RA_meta.f,SampDate~Family, value.var="Count", fun.aggregate=sum)) ###
...
ggsave(fsd1,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_fam.RA_barplot_sampdate.png", width=12, height=10, dpi=600)
...
ggsave(fsd1a,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_fam.RA_barplot_sampdate_1percent.png", width=12, height=10, dpi=600)
...
ggsave(fsd2,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_fam.RA_date_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(fsd3,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_fam.RA_date_taxasum_5percent.png", width=15, height=10, dpi=600)

# by Family + Sampling Date + Depth

bac.fam.date.dep <- as.data.frame(dcast(b.fam_RA_meta.f,SampDate+Depth_m~Family, value.var="Count", fun.aggregate=sum)) ###
...
ggsave(f.sd.d.h1,filename = "figures/Revised/RelativeAbundance/Family/16S_Families.RA_heatmap_date_depth_1perc.png", width=20, height=15, dpi=600)
...
ggsave(f.sd.d.h2,filename = "figures/Revised/RelativeAbundance/Family/16S_Families.RA_heatmap_date_depth_5perc.png", width=20, height=15, dpi=600)
...
ggsave(f.sd.d.hm.1,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_Families.RA_date_depth_taxasum_1perc.png", width=18, height=10, dpi=600)
...
ggsave(f.sd.d.hm.2,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_Families.RA_date_depth_taxasum_2.5perc.png", width=18, height=10, dpi=600)
...
ggsave(f.sd.d.hm.3,filename = "figures/Revised/RelativeAbundance/Family/SSW_16S_Families.RA_date_depth_taxasum_5perc.png", width=15, height=10, dpi=600)
...
# rename SampleID so it's easy to interpret, then reorder SampleID based on sample date, then depth
b.genus_RA_meta$SampleID = factor(b.genus_RA_meta$SampleID, levels=unique(b.genus_RA_meta$SampleID[order(b.genus_RA_meta$SampDate,b.genus_RA_meta$Depth_m)]), ordered=TRUE)

b.genus_RA_meta$PlotID = gsub("^SSW.","",b.genus_RA_meta$SampleID)
b.genus_RA_meta$PlotID = gsub("8.24.21.","Aug 24, 2021 ",b.genus_RA_meta$PlotID)
b.genus_RA_meta$PlotID = gsub("12.22.21.","Dec 22, 2021 ",b.genus_RA_meta$PlotID)
b.genus_RA_meta$PlotID = gsub("4.13.22.","Apr 13, 2022 ",b.genus_RA_meta$PlotID)
unique(b.genus_RA_meta$PlotID)
b.genus_RA_meta$PlotID = factor(b.genus_RA_meta$PlotID, levels=unique(b.genus_RA_meta$PlotID[order(b.genus_RA_meta$SampleID)]), ordered=TRUE)
...
b.gen_RAall<-ggplot(b.genus_RA_meta, aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Genus Relative Abundance", x="SampleID", y="Relative Abundance",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=9))

ggsave(b.gen_RAall,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot.png", width=35, height=10, dpi=600)
...
ggsave(b.gen_RA0,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_1perc.png", width=12, height=10, dpi=600)

b.gen_RA00<-ggplot(b.genus_RA_meta[b.genus_RA_meta$Count>0.02,], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Genus Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 2%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=2))

ggsave(b.gen_RA00,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_2perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA1,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_5perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA2,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_10perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA3,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_25perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA4,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_35perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen.a21_RA,filename = "figures/Revised/RelativeAbundance/Genus/16S_August2021_Genera.RA_1perc_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.gen.d21_RA,filename = "figures/Revised/RelativeAbundance/Genus/16S_December2021_Genera.RA_1perc_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.gen.a22_RA,filename = "figures/Revised/RelativeAbundance/Genus/16S_April2022_Genera.RA_1perc_barplot.png", width=12, height=10, dpi=600)

all.g.bymo<-ggarrange(b.gen.a21_RA, b.gen.d21_RA, b.gen.a22_RA,ncol = 3, nrow = 1)
ggsave(all.g.bymo,filename = "figures/Revised/RelativeAbundance/Genus/16S_MonthComparison_Genera.RA_1perc_barplot.png", width=25, height=10, dpi=600)
...
ggsave(b.gen.a21_RA2,filename = "figures/Revised/RelativeAbundance/Genus/16S_August2021_Genera.RA_5perc_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.gen.d21_RA2,filename = "figures/Revised/RelativeAbundance/Genus/16S_December2021_Genera.RA_5perc_barplot.png", width=12, height=10, dpi=600)
...
ggsave(b.gen.a22_RA2,filename = "figures/Revised/RelativeAbundance/Genus/16S_April2022_Genera.RA_5perc_barplot.png", width=12, height=10, dpi=600)

all.g.bymo2<-ggarrange(b.gen.a21_RA2, b.gen.d21_RA2, b.gen.a22_RA2,ncol = 3, nrow = 1)
ggsave(all.g.bymo2,filename = "figures/Revised/RelativeAbundance/Genus/16S_MonthComparison_Genera.RA_5perc_barplot.png", width=25, height=10, dpi=600)

## check taxa <1%
nonmaj.tax<-ggplot(b.genus_RA_meta[b.genus_RA_meta$Count<0.01,], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Genus Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes taxa with Relative Abundance < 1%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5,
        legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+facet_wrap(vars(SampDate),scales="free") + guides(fill=guide_legend(ncol=7))
ggsave(nonmaj.tax,filename = "figures/Revised/RelativeAbundance/Genus/16S_MonthComparison_Genera.RA_LessThan1perc_barplot.png", width=45, height=15, dpi=600)

b.gen.a21_RA3<-ggplot(aug.gen[aug.gen$Count<0.02,], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Genera Relative Abundance - August 2021", x="SampleID", y="Relative Abundance", subtitle="Includes taxa with Relative Abundance > 1%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=3))+scale_y_continuous(expand = c(0,0),limits = c(0,1))

ggsave(b.gen.a21_RA3,filename = "figures/Revised/RelativeAbundance/Genus/16S_August2021_Genera.RA_1perc_barplot.png", width=12, height=10, dpi=600)

b.gen.d21_RA3<-ggplot(dec.gen[dec.gen$Count<0.02,], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Genera Relative Abundance - December 2021", x="SampleID", y="Relative Abundance", subtitle="Includes taxa with Relative Abundance > 1%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=3))+scale_y_continuous(expand = c(0,0),limits = c(0,1))

ggsave(b.gen.d21_RA3,filename = "figures/Revised/RelativeAbundance/Genus/16S_December2021_Genera.RA_1perc_barplot.png", width=12, height=10, dpi=600)

b.gen.a22_RA3<-ggplot(apr.gen[apr.gen$Count<0.02,], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Genera Relative Abundance - April 2022", x="SampleID", y="Relative Abundance", subtitle="Includes taxa with Relative Abundance > 1%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=3))+scale_y_continuous(expand = c(0,0),limits = c(0,1))

ggsave(b.gen.a22_RA3,filename = "figures/Revised/RelativeAbundance/Genus/16S_April2022_Genera.RA_1perc_barplot.png", width=12, height=10, dpi=600)
...
ggsave(g.h1,filename = "figures/Revised/RelativeAbundance/Genus/16S_Genera.RA_heatmap_A_1perc.png", width=20, height=15, dpi=600)
...
ggsave(g.h2,filename = "figures/Revised/RelativeAbundance/Genus/16S_Genera.RA_heatmap_B_5perc.png", width=16, height=10, dpi=600)

b.fam_RA_meta[1:4,1:4]
#
# by Genus + Sampling Date
bac.gen.date <- as.data.frame(dcast(b.fam_RA_meta.g,SampDate~Genus, value.var="Count", fun.aggregate=sum)) ###
...
ggsave(gsd1,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_barplot.png", width=15, height=10, dpi=600)
...
ggsave(gsd1,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_taxasum_1perc.png", width=15, height=10, dpi=600)
...
ggsave(gsd1a,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_taxasum_1perc_v2.png", width=15, height=10, dpi=600)
...
ggsave(gsd1b,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_taxasum_5percent.png", width=15, height=10, dpi=600)
...
ggsave(gsd1c,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_taxasum_5percent_v2.png", width=15, height=10, dpi=600)

# by Genus + Sampling Date + Depth
bac.gen.date.dep <- as.data.frame(dcast(b.fam_RA_meta.g,SampDate+Depth_m~Genus, value.var="Count", fun.aggregate=sum)) ###
...
ggsave(g.sd.d.h1,filename = "figures/Revised/RelativeAbundance/Genus/16S_Genera.RA_heatmap_date_depth_1perc.png", width=20, height=15, dpi=600)
...
ggsave(g.sd.d.h2,filename = "figures/Revised/RelativeAbundance/Genus/16S_Genera.RA_heatmap_date_depth_5perc.png", width=20, height=15, dpi=600)
...
ggsave(g.sd.d.hm.1,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_depth_taxasum_1perc.png", width=18, height=10, dpi=600)
## ^ this figure includes the relative abundance of each organism by depth & date!!!
...
ggsave(g.sd.d.hm.2,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_depth_taxasum_2.5perc.png", width=18, height=10, dpi=600)
...
ggsave(g.sd.d.hm.2a,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_depth_taxasum_2.5perc_poster.png", width=18, height=10, dpi=600)
...
ggsave(g.sd.d.hm.3,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.RA_date_depth_taxasum_5perc.png", width=15, height=10, dpi=600)
...
b.gsp_counts <- as.data.frame(dcast(bac.dat.all.g, SampleID~Genus+Species, value.var="Count", fun.aggregate=sum)) ###
head(b.gsp_counts) # counts by genus per sample
dim(b.gsp_counts)
rownames(b.gsp_counts)<-b.gsp_counts$SampleID
b.gsp_counts[1:4,1:4]
b.gsp_counts<-b.gsp_counts[,colSums(b.gsp_counts[,-1])>0] # drop classes that are not represented
dim(b.gsp_counts) # sanity check that we dropped taxa with no hits

b.gsp_RelAb<-data.frame(decostand(b.gsp_counts[,-1], method="total", MARGIN=1, na.rm=TRUE))
# relative abundance of taxa data where everything is divided by col total (b/c Margin=1 meaning rows == SAMPLES in this case)
rowSums(b.gsp_RelAb) # sanity check to make sure the transformation worked!

b.gsp_RelAb$SampleID<-rownames(b.gsp_RelAb)
head(b.gsp_RelAb)
#write.csv(b.gsp_RelAb,"16S_Genera_Relative_Abundance.csv",row.names=TRUE) # good to save just in case

# melt down relativized data to merge with dust_meta
b.gsp_m<-melt(b.gsp_RelAb)

head(b.gsp_m)
colnames(b.gsp_m)[which(names(b.gsp_m) == "variable")] <- "Genus_species"
colnames(b.gsp_m)[which(names(b.gsp_m) == "value")] <- "Count"
head(b.gsp_m) ## relative abundance based on sum of counts by genus!
b.gsp_m$Genus_species<-gsub("^X.","",b.gsp_m$Genus_species) # get rid of leading X. in Genus_species names
b.gsp_m$Genus_species<-gsub("\\.\\."," ",b.gsp_m$Genus_species) # get rid of .. in species name --> . is regex
b.gsp_m$Genus_species<-gsub("\\."," ",b.gsp_m$Genus_species) # get rid of . in species name --> . is regex
b.gsp_m$Genus_species<-gsub("_"," ",b.gsp_m$Genus_species) #
head(b.gsp_m) ## relative abundance based on sum of counts by genus!

b.gsp_RA_meta<-merge(b.gsp_m,metadata, by="SampleID")
head(b.gsp_RA_meta) ## relative abundance based on sum of counts by genus!
max(b.gsp_RA_meta$Count)

# rename SampleID so it's easy to interpret, then reorder SampleID based on sample date, then depth
b.gsp_RA_meta$PlotID = gsub("^SSW.","",b.gsp_RA_meta$SampleID)
b.gsp_RA_meta$PlotID = gsub("8.24.21.","Aug 24, 2021 ",b.gsp_RA_meta$PlotID)
b.gsp_RA_meta$PlotID = gsub("12.22.21.","Dec 22, 2021 ",b.gsp_RA_meta$PlotID)
b.gsp_RA_meta$PlotID = gsub("4.13.22.","Apr 13, 2022 ",b.gsp_RA_meta$PlotID)
unique(b.gsp_RA_meta$PlotID)

saveRDS(b.gsp_RA_meta, file = "data/SSW_GenusSpecies_RelativeAbundance_Robject.rds", ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

# Barplot by SampleID
b.gen_RAall<-ggplot(b.gsp_RA_meta, aes(x=PlotID, y=Count, fill=Genus_species))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Species Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 1%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=9))

ggsave(b.gen_RAall,filename = "figures/Revised/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA.png", width=45, height=10, dpi=600)

b.gen_RA0<-ggplot(b.gsp_RA_meta[b.gsp_RA_meta$Count>0.01,], aes(x=PlotID, y=Count, fill=Genus_species))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Species Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 1%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=4))

ggsave(b.gen_RA0,filename = "figures/Revised/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_1perc_barplot.png", width=20, height=10, dpi=600)

b.gen_RA00<-ggplot(b.gsp_RA_meta[b.gsp_RA_meta$Count>0.02,], aes(x=PlotID, y=Count, fill=Genus_species))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Species Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 2%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=2))

ggsave(b.gen_RA00,filename = "figures/Revised/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_2perc_barplot.png", width=20, height=10, dpi=600)

b.gen_RA1<-ggplot(b.gsp_RA_meta[b.gsp_RA_meta$Count>0.05,], aes(x=PlotID, y=Count, fill=Genus_species))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Species Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 5%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=1))

ggsave(b.gen_RA1,filename = "figures/Revised/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_5perc_barplot.png", width=16, height=10, dpi=600)

b.gen_RA2<-ggplot(b.gsp_RA_meta[b.gsp_RA_meta$Count>0.10,], aes(x=PlotID, y=Count, fill=Genus_species))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Species Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 10%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=1))

ggsave(b.gen_RA2,filename = "figures/Revised/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_10perc_barplot.png", width=16, height=10, dpi=600)

b.gen_RA3<-ggplot(b.gsp_RA_meta[b.gsp_RA_meta$Count>0.15,], aes(x=PlotID, y=Count, fill=Genus_species))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Species Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 15%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=1))

ggsave(b.gen_RA3,filename = "figures/Revised/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_15perc_barplot.png", width=16, height=10, dpi=600)

b.gen_RA4<-ggplot(b.gsp_RA_meta[b.gsp_RA_meta$Count>0.25,], aes(x=PlotID, y=Count, fill=Genus_species))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Species Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 25%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=1))

ggsave(b.gen_RA4,filename = "figures/Revised/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_25perc_barplot.png", width=15, height=10, dpi=600)
...
ggsave(ten.gen,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_TenMostAbundant_Genera_barplot.png", width=12, height=10, dpi=600)

# break up top 10 genera by time point, then combine into one figure:
ten.aug<-ggplot(b.genus_RA_meta2[b.genus_RA_meta2$SampDate=="August.2021",], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_y_continuous(expand = c(0, 0))+theme_classic()+
  labs(x=" ", y=" ",fill="Genus")+
  theme(axis.title.x = element_text(size=30),axis.title.y = element_text(size=30),legend.title.align=0.5, legend.title = element_text(size=28),axis.text = element_text(size=28),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=30))+
...
ten.dec<-ggplot(b.genus_RA_meta2[b.genus_RA_meta2$SampDate=="December.2021",], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_y_continuous(expand = c(0, 0))+theme_classic()+
  labs(x=" ", y=" ", fill="Genus")+
  theme(axis.title.x = element_text(size=30),axis.title.y = element_text(size=30),legend.title.align=0.5, legend.title = element_text(size=28),axis.text = element_text(size=28),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=30))+
  guides(fill=guide_legend(ncol=1))+scale_fill_manual(name ="Genus",values=moma.colors("Lupi", 10),labels=c(unique(b.genus_RA_meta2$Genus[order(b.genus_RA_meta2$Genus)])))+
  coord_cartesian(ylim = c(0, 0.85))

ten.apr<-ggplot(b.genus_RA_meta2[b.genus_RA_meta2$SampDate=="April.2022",], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_y_continuous(expand = c(0, 0))+theme_classic()+
  labs(x=" ", y=" ",fill="Genus")+
  theme(axis.title.x = element_text(size=30),axis.title.y = element_text(size=30),legend.title.align=0.5, legend.title = element_text(size=28),axis.text = element_text(size=28),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=30))+
  guides(fill=guide_legend(ncol=1))+scale_fill_manual(name ="Genus",values=moma.colors("Lupi", 10),labels=c(unique(b.genus_RA_meta2$Genus[order(b.genus_RA_meta2$Genus)])))+
  coord_cartesian(ylim = c(0, 0.85))

ten.by.date<-ggarrange(ten.aug, ten.dec, ten.apr,ncol = 3, nrow = 1,legend="right",common.legend = TRUE)
ggsave(ten.by.date,filename = "figures/Revised/RelativeAbundance/Genus/16S_MonthComparison_Top10Genera.RA_barplot_paper.png", width=45, height=25, dpi=600,bg="white",create.dir=TRUE)
...
ggsave(ten.by.date,filename = "figures/Revised/RelativeAbundance/Genus/16S_MonthComparison_Top10Genera.RA_barplot.png", width=25, height=10, dpi=600,bg="white")

#### Genus Relative Abundance - August ####
# use dcast to count up ASVs within each Genus across aug of the samples
head(b.fam_RA_meta)
bac.dat.aug<-b.fam_RA_meta[b.fam_RA_meta$SampleMonth=="August",]
...
ggsave(b.gen_RA0,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Genera.Spec.RA_barplot_1perc.png", width=12, height=10, dpi=600)

b.gen_RA00<-ggplot(aug.genus_RA_meta[aug.genus_RA_meta$Count>0.02,], aes(x=PlotID, y=Count, fill=Genus_species))+geom_bar(stat="identity",colour="black")+scale_x_discrete()+theme_classic()+
  labs(title = "Microbial Genus Relative Abundance", x="SampleID", y="Relative Abundance", subtitle="Includes Taxa with Relative Abundance > 2%",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=11),axis.text.x = element_text(hjust=1,angle=45),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
  guides(fill=guide_legend(ncol=2))

ggsave(b.gen_RA00,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Genera.Spec.RA_barplot_2perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA1,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Genera.Spec.RA_barplot_5perc.png", width=12, height=10, dpi=600)
...
ggsave(gd1,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Aug21_Genus.RA_barplot_depth_1percent_B.png", width=12, height=10, dpi=600)
...
ggsave(gd1a,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Aug21_Genus.RA_barplot_depth_5percent_A.png", width=12, height=10, dpi=600)
...
ggsave(gd1b,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Aug21_Genus.RA_barplot_depth_5percent_B.png", width=12, height=10, dpi=600)
...
ggsave(tg1,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Aug21_Genera.RA_depth_taxasum_1perc.png", width=15, height=10, dpi=600)
...
ggsave(tg1a,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Aug21_Genera.RA_depth_taxasum_1perc_v2.png", width=15, height=10, dpi=600)
...
ggsave(tg1b,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Aug21_Genera.RA_depth_taxasum_5percent.png", width=15, height=10, dpi=600)
...
ggsave(tg1c,filename = "figures/Revised/RelativeAbundance/Genus/August2021/SSW_16S_Aug21_Genera.RA_depth_taxasum_5percent_v2.png", width=15, height=10, dpi=600)


#### Genus Relative Abundance - December ####
# use dcast to count up ASVs within each Genus across dec of the samples
head(b.fam_RA_meta)
bac.dat.dec<-b.fam_RA_meta[b.fam_RA_meta$SampleMonth=="December",]
...
#   guides(fill=guide_legend(ncol=2))
#
# ggsave(b.gen_RA0,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.Spec.RA_barplot_1perc.png", width=12, height=10, dpi=600)
#
...
#   guides(fill=guide_legend(ncol=1))
#
# ggsave(b.gen_RA1,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.Spec.RA_barplot_5perc.png", width=12, height=10, dpi=600)
#
...
#   guides(fill=guide_legend(ncol=1))
#
# ggsave(b.gen_RA2,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.Spec.RA_barplot_10perc.png", width=12, height=10, dpi=600)
#
...
#   guides(fill=guide_legend(ncol=1))
#
# ggsave(b.gen_RA3,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.Spec.RA_barplot_25perc.png", width=12, height=10, dpi=600)
#
...
#   guides(fill=guide_legend(ncol=1))
#
# ggsave(b.gen_RA4,filename = "figures/Revised/RelativeAbundance/Genus/SSW_16S_Genera.Spec.RA_barplot_35perc.png", width=12, height=10, dpi=600)
#
# # prep for heatmap
# max(dec.genus_RA_meta$Count)
...
ggsave(gd1,filename = "figures/Revised/RelativeAbundance/Genus/December2021/SSW_16S_Dec21_Genus.RA_barplot_depth_1percent_B.png", width=12, height=10, dpi=600)
...
ggsave(gd1a,filename = "figures/Revised/RelativeAbundance/Genus/December2021/SSW_16S_Dec21_Genus.RA_barplot_depth_5percent_A.png", width=12, height=10, dpi=600)
...
ggsave(gd1b,filename = "figures/Revised/RelativeAbundance/Genus/December2021/SSW_16S_Dec21_Genus.RA_barplot_depth_5percent_B.png", width=12, height=10, dpi=600)
...
ggsave(tg1,filename = "figures/Revised/RelativeAbundance/Genus/December2021/SSW_16S_Dec21_Genera.RA_depth_taxasum_1perc.png", width=15, height=10, dpi=600)
...
ggsave(tg1a,filename = "figures/Revised/RelativeAbundance/Genus/December2021/SSW_16S_Dec21_Genera.RA_depth_taxasum_1perc_v2.png", width=15, height=10, dpi=600)
...
ggsave(tg1b,filename = "figures/Revised/RelativeAbundance/Genus/December2021/SSW_16S_Dec21_Genera.RA_depth_taxasum_5percent.png", width=15, height=10, dpi=600)
...
ggsave(tg1c,filename = "figures/Revised/RelativeAbundance/Genus/December2021/SSW_16S_Dec21_Genera.RA_depth_taxasum_5percent_v2.png", width=15, height=10, dpi=600)


#### Genus Relative Abundance - April ####
# use dcast to count up ASVs within each Genus across apr of the samples
head(b.fam_RA_meta)
bac.dat.apr<-b.fam_RA_meta[b.fam_RA_meta$SampleMonth=="April",]
...
ggsave(gd1,filename = "figures/Revised/RelativeAbundance/Genus/April2022/SSW_16S_Apr22_Genus.RA_barplot_depth_1percent_B.png", width=12, height=10, dpi=600)
...
ggsave(gd1a,filename = "figures/Revised/RelativeAbundance/Genus/April2022/SSW_16S_Apr22_Genus.RA_barplot_depth_5percent_A.png", width=12, height=10, dpi=600)
...
ggsave(gd1b,filename = "figures/Revised/RelativeAbundance/Genus/April2022/SSW_16S_Apr22_Genus.RA_barplot_depth_5percent_B.png", width=12, height=10, dpi=600)
...
ggsave(tg1,filename = "figures/Revised/RelativeAbundance/Genus/April2022/SSW_16S_Apr22_Genera.RA_depth_taxasum_1perc.png", width=15, height=10, dpi=600)
...
ggsave(tg1a,filename = "figures/Revised/RelativeAbundance/Genus/April2022/SSW_16S_Apr22_Genera.RA_depth_taxasum_1perc_v2.png", width=15, height=10, dpi=600)
...
ggsave(tg1b,filename = "figures/Revised/RelativeAbundance/Genus/April2022/SSW_16S_Apr22_Genera.RA_depth_taxasum_5percent.png", width=15, height=10, dpi=600)
...
ggsave(tg1c,filename = "figures/Revised/RelativeAbundance/Genus/April2022/SSW_16S_Apr22_Genera.RA_depth_taxasum_5percent_v2.png", width=15, height=10, dpi=600)



#### Looking at Most Abundant Genus Only - DS001 ####
b.fam_RA_meta.g<-subset(b.fam_RA_meta, b.fam_RA_meta$Genus!="Unknown") # drop unknown genera so they don't skew analyses
...
ggsave(ds001.date.ts1,filename = "figures/Revised/RelativeAbundance/Genus/DS001/SSW_16S_DS001_RA_bydate_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(ds001.date.ts2,filename = "figures/Revised/RelativeAbundance/Genus/DS001/SSW_16S_DS001_RA_bydate_depth_taxasum.png", width=15, height=10, dpi=600)
...
#
# ggsave(ds001.dep.ts1,filename = "figures/Revised/RelativeAbundance/Genus/DS001/SSW_16S_DS001_RA_bydepth_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(ds001.dep.ts2,filename = "figures/Revised/RelativeAbundance/Genus/DS001/SSW_16S_DS001_RA_bydepth_date_taxasum.png", width=15, height=10, dpi=600)
...
ggsave(ds001.dep.ts3,filename = "figures/Revised/RelativeAbundance/Genus/DS001/SSW_16S_DS001_RA_bydepth_date_scatterplot.png", width=15, height=10, dpi=600)
...
ggsave(fig.ds001.dom.fit1,filename = "figures/Revised/RelativeAbundance/Genus/DS001/DS001_Genus_RelAb_vs_DOM_scatterplot.pdf", width=10, height=8, dpi=600)
...
## use summary(ds001.so4.fit1) to double check that stat_cor gives same p value as linear regression! it does here :)
ggsave(fig.ds001.dom.fit1a,filename = "figures/Revised/RelativeAbundance/Genus/DS001/DS001_Genus_RelAb_vs_DOM_scatterplot_noline.pdf", width=10, height=8, dpi=600)
...
## use summary(ds001.so4.fit1) to double check that stat_cor gives same p value as linear regression! it does here :)
ggsave(fig.ds001.so4.fit1,filename = "figures/Revised/RelativeAbundance/Genus/DS001/DS001_Genus_RelAb_vs_Sulfate_scatterplot.pdf", width=10, height=8, dpi=600)
...
ggsave(sh.t1,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_taxasum_type.png", width=23, height=10, dpi=600)
...
ggsave(sh.t1a,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_taxasum_type_1perc.png", width=23, height=10, dpi=600)
...
ggsave(sh.t2,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_taxasum_type_0.5perc.png", width=23, height=10, dpi=600)
...
ggsave(sh.t3,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_taxasum_type_0.25perc.png", width=23, height=10, dpi=600)
...
ggsave(share1,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.sw_population.pyramid.png", width=12, height=10, dpi=600)
...
ggsave(pp2,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.sw_population.pyramid.pretty.05percent.png", width=13, height=10, dpi=600)
...
ggsave(pp3,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.sw_population.pyramid.pretty.1percent.png", width=13, height=10, dpi=600)
...
ggsave(pp4,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.sw_population.pyramid.pretty.1percent_10.14.22.png", width=13, height=10, dpi=600)
...
ggsave(lg1,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.sw_lollipop_chart.png", width=13, height=10, dpi=600)
...
ggsave(share2,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.soil_population.pyramid.png", width=12, height=10, dpi=600)
...
ggsave(pp2a,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.soil_population.pyramid.pretty.05percent.png", width=13, height=10, dpi=600)
...
ggsave(pp3a,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.soil_population.pyramid.pretty.1percent.png", width=13, height=10, dpi=600)
...
ggsave(pp4a,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.soil_population.pyramid.pretty_1percent_10.14.22.png", width=13, height=10, dpi=600)
...
ggsave(lg1a,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_dust.v.soil_lollipop_chart.png", width=13, height=10, dpi=600)
...
ggsave(share3,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_sw.v.soil_population.pyramid.png", width=12, height=10, dpi=600)
...
ggsave(pp2b,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_sw.v.soil_population.pyramid.pretty.05percent.png", width=13, height=10, dpi=600)
...
ggsave(pp3b,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_sw.v.soil_population.pyramid.pretty.1percent.png", width=13, height=10, dpi=600)
...
ggsave(pp4b,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_sw.v.soil_population.pyramid.pretty.1percent.png", width=13, height=10, dpi=600)
...
ggsave(pp5b,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_sw.v.soil_population.pyramid.pretty_1percent.png", width=13, height=10, dpi=600)
...
ggsave(lg1a,filename = "figures/Revised/RelativeAbundance/16S_shared_Genera_sw.v.soil_lollipop_chart.png", width=13, height=10, dpi=600)
...
ggsave(ts1,filename = "figures/Revised/RelativeAbundance/16S_Gen.RA.png", width=20, height=10, dpi=600)
...
#ggsave(ts1a,filename = "figures/Revised/RelativeAbundance/16S_Phyla.RA2.png", width=15, height=10, dpi=600)
...
ggsave(g.t.05,filename = "figures/Revised/RelativeAbundance/16S_Gen.0.5percRA.png", width=15, height=10, dpi=600)
...
ggsave(g.t.05a,filename = "figures/Revised/RelativeAbundance/16S_Gen.0.5percRA.v2.png", width=15, height=10, dpi=600)
...
ggsave(g2,filename = "figures/Revised/RelativeAbundance/16S_Genera.RA_1percent_v1.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA.st,filename = "figures/Revised/RelativeAbundance/bacterial_genera_1percent_RA_by_SampleType.png", width=12, height=10, dpi=600)
...
ggsave(tp.h1,filename = "figures/Revised/RelativeAbundance/16S_Phyla.RA_heatmap.png", width=12, height=10, dpi=600)
...
ggsave(test1,filename = "figures/Revised/RelativeAbundance/16S_Gen.RA_sample.type_scatterplot.png", width=12, height=10, dpi=600)
...
ggsave(test2,filename = "figures/Revised/RelativeAbundance/16S_Gen.RA_type_linear1_colortest.png", width=12, height=10, dpi=600)
...
ggsave(tgc1,filename = "figures/Revised/RelativeAbundance/16S_Gen.RA_type_linear1.png", width=12, height=10, dpi=600)
