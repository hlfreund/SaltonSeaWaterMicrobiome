...
par(mar=c(1,1,1,1))
plot(mgm.euc.mr_dend, ylab="Median-Ratio, Euclidean Distance",cex = 0.5) + title(main = "Functional Clustering Dendrogram", cex.main = 1, font.main= 1, cex.sub = 0.8, font.sub = 3)
legend("topright",legend = c("August 2021","December 2021","April 2022"),cex=.8,col = c( "#ef781c","#03045e","#059c3f"),pch = 15, bty = "n")
...
ggsave(pcoa3,filename = "figures/Revised/MGM_Figs/FxnDiv/PCoAs/MedianRatioTransformation/SSW_MGM_pcoa_MR_sampdate.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa4,filename = "figures/Revised/MGM_Figs/FxnDiv/PCoAs/MedianRatioTransformation/SSW_MGM_pcoa_MR.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
#                             diff        lwr       upr     p adj
# December.2021-August.2021 -1993.5695 -5811.911 1824.772 0.3152075
# April.2022-August.2021    -1115.1172 -4933.459 2703.225 0.6622153
# April.2022-December.2021    878.4523 -2939.890 4696.794 0.7690979

# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/PCoAs/MedianRatioTransformation/SSW_MGM_pcoa_MR_betadispersion_sampledate.png',width = 700, height = 600, res=100)
par(mar=c(1,1,1,1))
plot(mgm.disper1,main = "Centroids and Dispersion (Median-Ratio Data)", col=colorset1$SampDate_Color)
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/PCoAs/MedianRatioTransformation/SSW_MGM_boxplot_MR_centroid_distance_sampledate.png',width = 700, height = 600, res=100)
...
#         diff       lwr      upr     p adj
#5-0   540.0586 -3833.740 4913.857 0.9248922
#10-0 1181.9451 -3191.853 5555.744 0.7002208
#10-5  641.8865 -3731.912 5015.685 0.8961055

colfunc <- colorRampPalette(c("red", "blue"))
colfunc(3)

# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/PCoAs/MedianRatioTransformation/ssw_mgm_pcoa_MR_betadispersion_depth.png',width = 700, height = 600, res=100)
plot(mgm.disper2,main = "Centroids and Dispersion (Median-Ratio Data)", col=colfunc(3))
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/PCoAs/MedianRatioTransformation/ssw_mgm_boxplot_MR_centroid_distance_depth.png',width = 700, height = 600, res=100)
...
ggsave(pcoa3,filename = "figures/Revised/MGM_Figs/FxnDiv/PCoAs/VarianceStabilizingTransformation/SSW_MGM_pcoa_VST_sampdate.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa4,filename = "figures/Revised/MGM_Figs/FxnDiv/PCoAs/VarianceStabilizingTransformation/SSW_MGM_pcoa_VST.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/PCoAs/VarianceStabilizingTransformation/SSW_MGM_pcoa_vst_betadispersion_sampledate.png',width = 700, height = 600, res=100)
plot(mgm.disper3,main = "Centroids and Dispersion (VST Data)", col=colorset1$SampDate_Color)
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/PCoAs/VarianceStabilizingTransformation/SSW_MGM_boxplot_vst_centroid_distance_sampledate.png',width = 700, height = 600, res=100)
...
# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/PCoAs/VarianceStabilizingTransformation/ssw_mgm_pcoa_VST_betadispersion_depth.png',width = 700, height = 600, res=100)
plot(mgm.disper2,main = "Centroids and Dispersion (VST Data)", col=colfunc(3))
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/PCoAs/VarianceStabilizingTransformation/ssw_mgm_boxplot_VST_centroid_distance_depth.png',width = 700, height = 600, res=100)
...
ggsave(pcoa6,filename = "figures/Revised/MGM_Figs/FxnDiv/PCoAs/CenterLogRatioTransformation/SSW_MGM_pcoa_CLR_SummedCoverage_Per_KO.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa5,filename = "figures/Revised/MGM_Figs/FxnDiv/PCoAs/RobustCenterLogRatioTransformation/SSW_MGM_pcoa_Robust CLR_SummedCoverage_Per_KO_sampdate.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa6,filename = "figures/Revised/MGM_Figs/FxnDiv/PCoAs/RobustCenterLogRatioTransformation/SSW_MGM_pcoa_Robust CLR_SummedCoverage_Per_KO.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
#
# ## pull out all KOs in each Pathway (CLR transformed summed coverages of KOs)
...
sulf.hm1a<-ggplot(clr.sulf.all, aes(PlotID, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  ...
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.5","0.6","-0.3"),breaks=c(1.5,0.6,-0.3)) + labs(title="Sulfur Metabolism in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
...
ggsave(sulf.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampID_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1a2,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampID_by_Function_Pathway_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1a3,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampleID_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1a4,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampID_by_Function_Pathway_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1a5,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampleID_by_Function_SampDate_Pathway_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1a6,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampleID_by_Function_SampDate_Pathway_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1a7,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampleID_by_Function_SampDate_PathwaySpecific_best_heatmap.png", width=20, height=20, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1a8,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampleID_by_Function_SampDate_PathwaySpecific_best_heatmap2.png", width=20, height=20, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Pathway~.,scales="free_y", space = "free")
#
# ggsave(sulf.hm1c,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampDate_Depth_by_Function_Pathway_heatmap.png", width=15, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(sulf.hm1c2,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_SampDate_Depth_by_Function_Pathway_heatmap2.png", width=15, height=18, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Depth_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Depth_by_Function_Pathway_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1b3,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1b4,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Depth_by_Function_Pathway_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1b5,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1b6,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1b7,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_PathwaySpecific_heatmap.png", width=20, height=20, dpi=600,create.dir=TRUE)
...
ggsave(sulf.hm1b8,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_PathwaySpecific_best_heatmap.png", width=20, height=20, dpi=600,create.dir=TRUE)
...
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.5","0.6","-0.3"),breaks=c(1.5,0.6,-0.3)) + labs(title="Sulfur Metabolism in Salton Seawater Metagenomes - 0m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
...
#
# ggsave(sulf.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_Pathways_MGMs_0m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
# sulf.hm1f<-ggplot(clr.sulf.all[clr.sulf.all$Depth_m==5,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.5","0.6","-0.3"),breaks=c(1.5,0.6,-0.3)) + labs(title="Sulfur Metabolism in Salton Seawater Metagenomes - 5m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(sulf.hm1f,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_Pathways_MGMs_5m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
# sulf.hm1g<-ggplot(clr.sulf.all[clr.sulf.all$Depth_m==10,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.5","0.6","-0.3"),breaks=c(1.5,0.6,-0.3)) + labs(title="Sulfur Metabolism in Salton Seawater Metagenomes - 10m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(sulf.hm1g,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Sulfur_KOFxns_Pathways_MGMs_10m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
...
ggsave(soxa.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/SoxA_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(soxb.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/SoxB_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(soxx.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/SoxX_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(soxy.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/SoxY_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(soxz.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/SoxZ_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(soxd.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/SoxD_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(soxc.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/SoxC_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(soeA.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/soeA_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(sqr.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/sqr_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(fccB.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/fccB_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(aprA.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/aprA_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(dsrB.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/dsrB_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(dsrA.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/dsrA_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(aprB.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/aprB_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(sir.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/sir_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(cysNC.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/CysNC_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
#   xlab("SampleID") + ylab("CLR-Transformed Coverage")
#
# ggsave(CysN.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/CysN_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(cysH.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/CysH_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
#   xlab("SampleID") + ylab("CLR-Transformed Coverage")
#
# ggsave(cysC.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/CysC_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(cysI.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/CysI_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(cysD.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/CysD_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(phsA.psrA.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/phsA.psrA_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(sat.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/Fxn_Scatterplots/sat_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(sulf.bi.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(sulf.bi.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.bi.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Depth_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.bi.hm1c,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(sulf.bi.hm1c2,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(sulf.bi.hm1d,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sulf.bi.hm1d2,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathwaySpecific~SampDate, scales="free", space = "free")
#
# ggsave(sulf.bi.hm1c2,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_by_Function_SampDate_PathwaySpecific_Binary_best_heatmap.png", width=20, height=20, dpi=600,create.dir=TRUE)
...
ggsave(sulf.bi.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_PathwaySpecific_Binary_best_heatmap.png", width=20, height=20, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
#
# ggsave(sulf.bi.hm1e0,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_Pathways_Binary_0m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(sulf.bi.hm1e5,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_Pathways_Binary_5m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(sulf.bi.hm1e6,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_Pathways_Binary_10m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
...
nitro.hm1a<-ggplot(clr.nitro.all, aes(PlotID, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.4","0.5","-0.4"),breaks=c(1.4,0.5,-0.4)) + labs(title="Nitrogen Metabolism in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(nitro.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_SampID_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1a2,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_SampID_by_Function_Pathway_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1a3,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_SampleID_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1a4,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_SampID_by_Function_Pathway_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1a5,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_SampleID_by_Function_SampDate_Pathway_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1a6,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_SampleID_by_Function_SampDate_Pathway_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_Depth_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_Depth_by_Function_Pathway_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1b3,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_Depth_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1b4,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_Depth_by_Function_Pathway_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1b5,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.hm1b6,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)

# nitro.hm1e<-ggplot(clr.nitro.all[clr.nitro.all$Depth_m==0,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.4","0.5","-0.4"),breaks=c(1.4,0.5,-0.4)) + labs(title="Nitrogen Metabolism in Salton Seawater Metagenomes - 0m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.x = element_text(size = 11,face="bold")) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(nitro.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_Pathways_MGMs_0m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
# nitro.hm1f<-ggplot(clr.nitro.all[clr.nitro.all$Depth_m==5,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.4","0.5","-0.4"),breaks=c(1.4,0.5,-0.4)) + labs(title="Nitrogen Metabolism in Salton Seawater Metagenomes - 5m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(nitro.hm1f,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_Pathways_MGMs_5m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
# nitro.hm1g<-ggplot(clr.nitro.all[clr.nitro.all$Depth_m==10,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.4","0.5","-0.4"),breaks=c(1.4,0.5,-0.4)) + labs(title="Nitrogen Metabolism in Salton Seawater Metagenomes - 10m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(nitro.hm1g,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/Nitrogen_KOFxns_Pathways_MGMs_10m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
...
ggsave(nitro.bi.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(nitro.bi.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.bi.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_Depth_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.bi.hm1d,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(nitro.bi.hm1d2,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_Depth_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(nitro.bi.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(nitro.bi.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
#
# ggsave(nitro.bi.hm1e0,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_Pathways_Binary_0m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(nitro.bi.hm1e5,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_Pathways_Binary_5m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(nitro.bi.hm1e6,filename = "figures/Revised/MGM_Figs/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_Pathways_Binary_10m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
...
carb.hm1a<-ggplot(clr.carb.all, aes(PlotID, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.8","0.7","-0.4"),breaks=c(1.8,0.7,-0.4)) + labs(title="Carbon Metabolism in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(carb.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_SampID_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1a2,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_SampID_by_Function_Pathway_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1a3,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_SampleID_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1a4,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_SampID_by_Function_Pathway_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1a5,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_SampleID_by_Function_SampDate_Pathway_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1a6,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_SampleID_by_Function_SampDate_Pathway_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Depth_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Depth_by_Function_Pathway_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1b3,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Depth_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1b4,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Depth_by_Function_Pathway_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1b5,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.hm1b6,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)

# carb.hm1e<-ggplot(clr.carb.all[clr.carb.all$Depth_m==0,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.8","0.7","-0.4"),breaks=c(1.8,0.7,-0.4)) + labs(title="Carbon Metabolism in Salton Seawater Metagenomes - 0m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.x = element_text(size = 11,face="bold")) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(carb.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_Pathways_MGMs_0m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
# carb.hm1f<-ggplot(clr.carb.all[clr.carb.all$Depth_m==5,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.8","0.7","-0.4"),breaks=c(1.8,0.7,-0.4)) + labs(title="Carbon Metabolism in Salton Seawater Metagenomes - 5m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(carb.hm1f,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_Pathways_MGMs_5m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
# carb.hm1g<-ggplot(clr.carb.all[clr.carb.all$Depth_m==10,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.8","0.7","-0.4"),breaks=c(1.8,0.7,-0.4)) + labs(title="Carbon Metabolism in Salton Seawater Metagenomes - 10m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(carb.hm1g,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/Carbon_KOFxns_Pathways_MGMs_10m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
...
ggsave(carb.bi.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(carb.bi.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.bi.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_Depth_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.bi.hm1d,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(carb.bi.hm1d2,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_Depth_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(carb.bi.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(carb.bi.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
#
# ggsave(carb.bi.hm1e0,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_Pathways_Binary_0m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(carb.bi.hm1e5,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_Pathways_Binary_5m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(carb.bi.hm1e6,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_Pathways_Binary_10m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
...
photo.hm1a<-ggplot(clr.photo.all, aes(PlotID, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.25","0.5","-0.3"),breaks=c(1.25,0.5,-0.3)) + labs(title="Phototrophy Metabolism in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(photo.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_SampID_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_SampID_by_Function_Phototrophy_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1c,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_SampleID_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1d,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_SampID_by_Function_Phototrophy_System_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_SampleID_by_Function_SampDate_Phototrophy_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1f,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_SampleID_by_Function_SampDate_Phototrophy_System_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1g,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_SampleID_by_Function_SampDate_Phototrophy_Method_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))
#
# ggsave(photo.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Depth_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Depth_by_Function_Phototrophy_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1c2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Depth_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1d2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Depth_by_Function_Phototrophy_System_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1e2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Depth_by_Function_SampDate_Phototrophy_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1f2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Depth_by_Function_SampDate_Phototrophy_System_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.hm1e2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Depth_by_Function_SampDate_Phototrophy_Method_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(blh.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Fxn_Scatterplots/Blh_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(sop.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Fxn_Scatterplots/Sop_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(psbA.scat,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/Fxn_Scatterplots/PsbA_CLR_Coverage_SampleID_scatterplot.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_System_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1c,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_Phototrophy_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1d,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_SampDate_System_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1f,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_SampDate_Phototrophy_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1g,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_SampDate_Photo_Method_Binary_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Depth_by_Function_System_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1c2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Depth_by_Function_Phototrophy_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1d2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Depth_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1e2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Depth_by_Function_SampDate_System_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1f2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Depth_by_Function_SampDate_Phototrophy_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(photo.bi.hm1g2,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Depth_by_Function_SampDate_Photo_Method_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
#
# ggsave(photo.bi.hm1e0,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_Phototrophys_Binary_0m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(photo.bi.hm1e5,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_Phototrophys_Binary_5m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(photo.bi.hm1e6,filename = "figures/Revised/MGM_Figs/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_Phototrophys_Binary_10m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
...
aero.hm1a<-ggplot(clr.aero.all, aes(PlotID, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.75","0.75","0","-0.5"),breaks=c(1.75,1,0,-0.5)) + labs(title="Aerobic Respiration in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(aero.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_SampID_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)

# aero.hm1b<-ggplot(clr.aero.all, aes(PlotID, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.15) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.75","0.75","0","-0.5"),breaks=c(1.75,0.75,0,-0.5)) + labs(title="Aerobic Respiration in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.y = element_text(size = 11,face="bold")) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Enzyme~.,scales="free_y", space = "free")
#
# ggsave(aero.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_SampID_by_Function_Aerobic_Respiration_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(aero.hm1c,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_SampleID_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(aero.hm1d,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_SampID_by_Function_Aerobic_Respiration_Enzyme_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
#
...
#
# ggsave(aero.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_SampleID_by_Function_SampDate_Aerobic_Respiration_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(aero.hm1f,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_SampleID_by_Function_SampDate_Aerobic_Respiration_Enzyme_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(EnzShort~SampDate, scales="free", space = "free")
#
# ggsave(aero.hm1g,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_SampleID_by_Function_SampDate_Aerobic_Respiration_Enzyme_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))
#
# ggsave(aero.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(aero.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_Aerobic_Respiration_Enzyme_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(aero.hm1c2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(aero.hm1d2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_Aerobic_Respiration_Enzyme_heatmap2.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Enzyme~SampDate, scales="free", space = "free")
#
# ggsave(aero.hm1e2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_SampDate_Aerobic_Respiration_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(aero.hm1f2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_SampDate_Aerobic_Respiration_Enzyme_best_heatmap2.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(EnzShort~SampDate, scales="free", space = "free")
#
# ggsave(aero.hm1e2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_SampDate_Aerobic_Respiration_Enzyme_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(aero.bi.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(aero.bi.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_by_Function_Enzyme_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Enzyme~.,scales="free_y", space = "free")
#
# ggsave(aero.bi.hm1c,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_by_Function_Aerobic_Respiration_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(aero.bi.hm1d,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(aero.bi.hm1e,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_by_Function_SampDate_Enzyme_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Enzyme~SampDate, scales="free", space = "free")
#
# ggsave(aero.bi.hm1f,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_by_Function_SampDate_Aerobic_Respiration_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(EnzShort~SampDate, scales="free", space = "free")
#
# ggsave(aero.bi.hm1g,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_by_Function_SampDate_Photo_Enzyme_Binary_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
ggsave(aero.bi.hm1b2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_Enzyme_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Enzyme~.,scales="free_y", space = "free")
#
# ggsave(aero.bi.hm1c2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_Aerobic_Respiration_Binary_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(aero.bi.hm1d2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600,create.dir=TRUE)
...
ggsave(aero.bi.hm1e2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_SampDate_Enzyme_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Enzyme~SampDate, scales="free", space = "free")
#
# ggsave(aero.bi.hm1f2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_SampDate_Aerobic_Respiration_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(EnzShort~SampDate, scales="free", space = "free")
#
# ggsave(aero.bi.hm1g2,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Depth_by_Function_SampDate_Photo_Enzyme_Binary_best_heatmap.png", width=20, height=15, dpi=600,create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
#
# ggsave(aero.bi.hm1e0,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_Aerobic Respirations_Binary_0m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(aero.bi.hm1e5,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_Aerobic Respirations_Binary_5m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(aero.bi.hm1e6,filename = "figures/Revised/MGM_Figs/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_Aerobic Respirations_Binary_10m_heatmap.png", width=18, height=18, dpi=600,create.dir=TRUE)
...
All_GOI.hm1a<-ggplot(clr.All_GOI.all, aes(PlotID, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("1.5","0.5","-0.5"),breaks=c(1.5,0.5,-0.5)) + labs(title="All Genes of Interest by Pathway & Cycle in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(All_GOI.hm1a,filename = "figures/Revised/MGM_Figs/FxnDiv/All_GOI/All_GOI_KOFxns_MGMs_SampID_by_Function_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(All_GOI.hm1b,filename = "figures/Revised/MGM_Figs/FxnDiv/All_GOI/All_GOI_KOFxns_MGMs_SampID_by_Function_Pathway_heatmap.png", width=20, height=23, dpi=600,create.dir=TRUE)
...
ggsave(All_GOI.hm1c,filename = "figures/Revised/MGM_Figs/FxnDiv/All_GOI/All_GOI_KOFxns_MGMs_SampID_by_Function_Cycle_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(All_GOI.hm1d,filename = "figures/Revised/MGM_Figs/FxnDiv/All_GOI/All_GOI_KOFxns_MGMs_SampID_by_Function_Pathway_SampDate_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ggsave(All_GOI.hm1a1,filename = "figures/Revised/MGM_Figs/FxnDiv/All_GOI/All_GOI_KOFxns_MGMs_Depth_by_Function_Pathway_heatmap.png", width=18, height=13, dpi=600,create.dir=TRUE)
...
ggsave(All_GOI.hm1b1,filename = "figures/Revised/MGM_Figs/FxnDiv/All_GOI/All_GOI_KOFxns_MGMs_Depth_by_Function_Cycle_heatmap.png", width=20, height=23, dpi=600,create.dir=TRUE)
...
ggsave(All_GOI.hm1c1,filename = "figures/Revised/MGM_Figs/FxnDiv/All_GOI/All_GOI_KOFxns_MGMs_Depth_by_Function_Pathway_SampDate_heatmap.png", width=17, height=15, dpi=600,create.dir=TRUE)
...
ars.hm1<-ggplot(clr.ars.all, aes(PlotID, KO_Function, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43") + labs(title="Arsenic Functions in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
...
ggsave(ars.hm1,filename = "figures/Revised/MGM_Figs/FxnDiv/Arsenic/Arsenic_KOFxns_MGMs_heatmap1.png", width=18, height=15, dpi=600,create.dir=TRUE)
...
ggsave(ars.hm2,filename = "figures/Revised/MGM_Figs/FxnDiv/Arsenic/Arsenic_KOFxns_MGMs_heatmap_better.png", width=18, height=12, dpi=600,create.dir=TRUE)
...
sel.hm1<-ggplot(clr.sel.all, aes(PlotID, KO_Function, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43") + labs(title="Selenium Functions in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=15),axis.title.y = element_text(size=15),legend.title.align=0.5, legend.title = element_text(size=15),
        axis.text = element_text(size=12),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=12),plot.title = element_text(size=17),
        axis.ticks=element_line(size=0.4),panel.border=element_blank()) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(sel.hm1,filename = "figures/Revised/MGM_Figs/FxnDiv/Selenium/Selenium_KOFxns_MGMs_heatmap1.png", width=18, height=15, dpi=600,create.dir=TRUE)
...
ggsave(sel.hm2,filename = "figures/Revised/MGM_Figs/FxnDiv/Selenium/Selenium_KOFxns_MGMs_heatmap_better.png", width=18, height=12, dpi=600,create.dir=TRUE)
...
osmo.hm1<-ggplot(clr.osmo.all, aes(PlotID, KO_Function, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43") + labs(title="Osmoprotectant Functions in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=15),axis.title.y = element_text(size=15),legend.title.align=0.5, legend.title = element_text(size=15),
        axis.text = element_text(size=12),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=12),plot.title = element_text(size=17),
        axis.ticks=element_line(size=0.4),panel.border=element_blank()) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(osmo.hm1,filename = "figures/Revised/MGM_Figs/FxnDiv/OsmoProctection_Tolerance/OsmoProtectant_KOFxns_MGMs_heatmap1.png", width=18, height=12, dpi=600,create.dir=TRUE)

osmo.hm2<-ggplot(clr.osmo.all, aes(Depth_m, KO_Function, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43") + labs(title="Osmoprotectant & Tolerance Functions in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=15),axis.title.y = element_text(size=15),legend.title.align=0.5, legend.title = element_text(size=15),
        axis.text = element_text(size=12),axis.text.x = element_text(),legend.text = element_text(size=12),plot.title = element_text(size=17),
        axis.ticks=element_line(size=0.4),panel.border=element_blank()) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(osmo.hm2,filename = "figures/Revised/MGM_Figs/FxnDiv/OsmoProctection_Tolerance/OsmoProtectant_KOFxns_MGMs_heatmap_better.png", width=18, height=12, dpi=600,create.dir=TRUE)
...
met.hm1<-ggplot(clr.met.all, aes(PlotID, KO_Function, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43") + labs(title="Metal Resistance & Tolerance Functions in Salton Seawater Metagenomes",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=15),axis.title.y = element_text(size=15),legend.title.align=0.5, legend.title = element_text(size=15),
        axis.text = element_text(size=12),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=12),plot.title = element_text(size=17),
        axis.ticks=element_line(size=0.4),panel.border=element_blank()) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(met.hm1,filename = "figures/Revised/MGM_Figs/FxnDiv/MetalResist_Tolerance/Metal_ResistToler_KOFxns_MGMs_heatmap1.png", width=18, height=15, dpi=600,create.dir=TRUE)
...
ggsave(met.hm2,filename = "figures/Revised/MGM_Figs/FxnDiv/MetalResist_Tolerance/Metal_ResistToler_KOFxns_MGMs_heatmap_better.png", width=18, height=15, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.s1,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/SSW_SulfurOnly_pcoa_CLR_SummedCoverage_Per_KO_sampdate.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.s2,filename = "figures/Revised/MGM_Figs/FxnDiv/Sulfur/SSW_SulfurOnly_pcoa_CLR_SummedCoverage_Per_KO.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.s1,filename = "figures/Revised/MGM_Figs/FxnDiv/DOM/SSW_DOMOnly_pcoa_CLR_SummedCoverage_Per_KO_sampdate.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.s2,filename = "figures/Revised/MGM_Figs/FxnDiv/DOM/SSW_DOMOnly_pcoa_CLR_SummedCoverage_Per_KO.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.s1,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/SSW_CarbonFixationOnly_pcoa_CLR_SummedCoverage_Per_KO_sampdate.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.s2,filename = "figures/Revised/MGM_Figs/FxnDiv/Carbon/SSW_CarbonFixationOnly_pcoa_CLR_SummedCoverage_Per_KO.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.a1,filename = "figures/Revised/MGM_Figs/FxnDiv/Arsenic/SSW_ArsenicOnly_pcoa_CLR_SummedCoverage_Per_KO_sampdate.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.a2,filename = "figures/Revised/MGM_Figs/FxnDiv/Arsenic/SSW_ArsenicOnly_pcoa_CLR_SummedCoverage_Per_KO.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.m1,filename = "figures/Revised/MGM_Figs/FxnDiv/MetalResist_Tolerance/SSW_MetalResistTolerance_pcoa_CLR_SummedCoverage_Per_KO_sampdate.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
ggsave(pcoa.m2,filename = "figures/Revised/MGM_Figs/FxnDiv/MetalResist_Tolerance/SSW_MetalResistTolerance_pcoa_CLR_SummedCoverage_Per_KO.traits_depth.png", width=12, height=10, dpi=600,create.dir=TRUE)
...
# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/SSW_MGM_pcoa_CLR_SummedCoverage_perKO_betadispersion_sampledate.png',width = 700, height = 600, res=100)
plot(mgm.disper,main = "Centroids and Dispersion based on Aitchison Distance (CLR Data)", col=colorset1$SampDate_Color)
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/SSW_MGM_boxplot_CLR_SummedCoverage_perKO_centroid_distance_sampledate.png',width = 700, height = 600, res=100)
...
# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/ssw_mgm_pcoa_CLR_SummedCoverage_per_KO_betadispersion_depth.png',width = 700, height = 600, res=100)
plot(mgm.disper2,main = "Centroids and Dispersion based on Aitchison Distance (CLR Data)", col=colfunc(3))
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/ssw_mgm_boxplot_CLR_SummedCoverage_per_KO_centroid_distance_depth.png',width = 700, height = 600, res=100)
...
# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/SSW_MGM_pcoa_CLR_SummedCoverage_perKO_SulfurOnly_betadispersion_sampledate.png',width = 700, height = 600, res=100)
plot(sulf.disper1,main = "Centroids and Dispersion based on Aitchison Distance (Sulfur CLR Data)", col=colorset1$SampDate_Color)
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/SSW_MGM_boxplot_CLR_SummedCoverage_perKO_SulfurOnly_centroid_distance_sampledate.png',width = 700, height = 600, res=100)
...
# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/ssw_mgm_pcoa_CLR_SummedCoverage_per_KO_SulfOnly_betadispersion_depth.png',width = 700, height = 600, res=100)
plot(sulf.disper2,main = "Centroids and Dispersion based on Aitchison Distance (Sulfur CLR Data)", col=colfunc(3))
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/ssw_mgm_boxplot_CLR_SummedCoverage_per_KO_SulfOnly_centroid_distance_depth.png',width = 700, height = 600, res=100)
...
s.pnov6<-adonis2(clr.cov.sum.sulf.ko[,-1] ~ SampDate,data=meta_scaled,method = "euclidean",by="terms",permutations=perm)
s.pnov6
...
# Visualize dispersions
png('figures/Revised/MGM_Figs/FxnDiv/SSW_SOX_PCoA_betadispersion_sampledate.png',width = 700, height = 600, res=100)
plot(sox.disper1,main = "SOX Functions - Centroids and Dispersion (Median-Ratio Data)", label=FALSE,col=colorset1$SampDate_Color)
dev.off()

png('figures/Revised/MGM_Figs/FxnDiv/SSW_SOX_boxplot_MR_centroid_distance_sampledate.png',width = 700, height = 600, res=100)
