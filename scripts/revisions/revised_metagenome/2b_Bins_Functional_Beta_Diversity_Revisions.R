...
#ggsave(bin.pcoa1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/SSW_MAG_Bin_pcoa_CLR_SummedCoverage_Per_KO_sampdate.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggplot(bin.pcoa.clr.meta, aes(x=Axis.1, y=Axis.2)) +theme_bw()+
  ...
  scale_color_continuous(low="blue3",high="red",trans = 'reverse') + scale_shape_discrete(labels=c("August 2021","December 2021","April 2022"),name="Sample Date") +
  xlab("PC1 [32.17%]") + ylab("PC2 [11.98%]")
#ggsave(bin.pcoa2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/SSW_MAG_Bin_pcoa_CLR_SummedCoverage_Per_KO.traits_depth.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
# create labels so each plotbin matches its genus for labeling
bin.labs.gen.list<-unique(data.frame(Genus=clr.sulf.all.bin$Genus,PlotBin=clr.sulf.all.bin$PlotBin))
bin.labs.gen.list$Genus = factor(bin.labs.gen.list$Genus, levels=unique(bin.labs.gen.list$Genus[order(bin.labs.gen.list$PlotBin)]), ordered=TRUE)
clr.sulf.all.bin$Genus<-factor(clr.sulf.all.bin$Genus,levels=unique(clr.sulf.all.bin$Genus[order(clr.sulf.all.bin$PlotBin,clr.sulf.all.bin$SampDate)]), ordered=TRUE)
bin.labs<-c("8.24.21.0m.bin.15"="HIMB30","8.24.21.10m.bin.22"="HIMB30","12.22.21.0m.bin.11"="Casp-actino5","12.22.21.0m.bin.13"="HIMB30","12.22.21.0m.bin.7"="Unknown",
            "12.22.21.5m.bin.3"="Casp-actino5","12.22.21.5m.bin.30"="HIMB30","12.22.21.10m.bin.17"="HIMB30","12.22.21.10m.bin.2"="SKUL01",
            "12.22.21.10m.bin.6"="Unknown","12.22.21.10m.bin.7"="Unknown","4.13.22.0m.bin.16"="HIMB30","4.13.22.5m.bin.24"="HIMB30","4.13.22.10m.bin.8"="HIMB30")

# Figures

sulf.hm1a<-ggplot(clr.sulf.all.bin, aes(PlotBin, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Sulfur Metabolism in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
...
ggsave(sulf.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_BinID_by_Function_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)

sulf.hm1a1<-ggplot(clr.sulf.all.bin, aes(PlotBin, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Sulfur Metabolism in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0),labels=bin.labs)

ggsave(sulf.hm1a1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_BinID_and_Genus_by_Function_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1a2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_BinID_by_Function_heatmap2.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_BinID_by_Function_Pathway_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1b2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_BinID_by_Function_Pathway_heatmap2.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1b3,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_Genus_by_Function_Pathway_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)

sulf.hm1c<-ggplot(clr.sulf.all.bin, aes(PlotBin, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Sulfur Metabolism in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=13),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=15),strip.text = element_text(size = 15),strip.text.y=element_text(face="bold")) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+
  facet_grid(PathwaySpecific~SampDate, scales="free", space = "free",axis.labels="all") +scale_x_discrete(expand=c(0, 0),labels=c("8.24.21.0m.bin.15"="HIMB30","8.24.21.10m.bin.22"="HIMB30","12.22.21.0m.bin.11"="Casp-actino5","12.22.21.0m.bin.13"="HIMB30","12.22.21.0m.bin.7"="Unknown",
                                                                                                                                  "12.22.21.5m.bin.3"="Casp-actino5","12.22.21.5m.bin.30"="HIMB30","12.22.21.10m.bin.17"="HIMB30","12.22.21.10m.bin.2"="SKUL01",
                                                                                                                                  "12.22.21.10m.bin.6"="Unknown","12.22.21.10m.bin.7"="Unknown","4.13.22.0m.bin.16"="HIMB30","4.13.22.5m.bin.24"="HIMB30","4.13.22.10m.bin.8"="HIMB30"))

ggsave(sulf.hm1c,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_BinID_by_Function_SampDate_PathwaySpecific_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)

sulf.hm1c2<-ggplot(clr.sulf.all.bin, aes(PlotBin, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Sulfur Metabolism in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=18),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=16),strip.text = element_text(size = 14),strip.text.y=element_text(face="bold")) +
  xlab("") + ylab("") + facet_grid(PathSpecShort~SampDate, scales="free", space = "free") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0),labels=c("8.24.21.0m.bin.15"="HIMB30","8.24.21.10m.bin.22"="HIMB30","12.22.21.0m.bin.11"="Casp-actino5","12.22.21.0m.bin.13"="HIMB30","12.22.21.0m.bin.7"="Unknown",
                                                                                                                                                                      "12.22.21.5m.bin.3"="Casp-actino5","12.22.21.5m.bin.30"="HIMB30","12.22.21.10m.bin.17"="HIMB30","12.22.21.10m.bin.2"="SKUL01",
                                                                                                                                                                      "12.22.21.10m.bin.6"="Unknown","12.22.21.10m.bin.7"="Unknown","4.13.22.0m.bin.16"="HIMB30","4.13.22.5m.bin.24"="HIMB30","4.13.22.10m.bin.8"="HIMB30"))

ggsave(sulf.hm1c2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_BinID_with_Genus_by_Function_SampDate_PathwaySpecific_best_heatmap2.png", width=22, height=15, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1c3,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_Genus_by_Function_SampDate_PathwaySpecific_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1c4,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_Genus_by_Function_SampDate_PathwaySpecific_best_heatmap2.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1d2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_Depth_by_Function_SampDate_PathwaySpecific_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1d2a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_Depth_by_Function_SampDate_PathwaySpecific_best_heatmap2.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Pathway~.,scales="free_y", space = "free")
#
# ggsave(sulf.hm1c,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_SampDate_Depth_by_Function_Pathway_heatmap.png", width=15, height=18, dpi=600, create.dir=TRUE)
...
ggsave(sulf.hm1d,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_Depth_by_Function_SampDate_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
#
# ggsave(sulf.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_Depth_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
...
#
# ggsave(sulf.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_heatmap1d.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#
# ggsave(sulf.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_MGMs_Bins_heatmap1d.png", width=18, height=18, dpi=600, create.dir=TRUE)

# sulf.hm1e<-ggplot(clr.sulf.all.bin[clr.sulf.all.bin$Depth_m==0,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Sulfur Metabolism in Salton Seawater MAGs - 0m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.x = element_text(size = 11,face="bold")) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(sulf.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_Pathways_MGMs_Bins_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
# sulf.hm1f<-ggplot(clr.sulf.all.bin[clr.sulf.all.bin$Depth_m==5,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Sulfur Metabolism in Salton Seawater MAGs - 5m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(sulf.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_Pathways_MGMs_Bins_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
# sulf.hm1g<-ggplot(clr.sulf.all.bin[clr.sulf.all.bin$Depth_m==10,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Sulfur Metabolism in Salton Seawater MAGs - 10m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(sulf.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/Sulfur_KOFxns_Pathways_MGMs_Bins_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
# #
...
#   geom_tile(colour="white",size=0.25)  +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",na.value="grey50",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="SOX Functions in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO, Grouped by Bin Assigment",fill="CLR Coverage Per KO") +
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0)) + facet_grid(.~SampDate)
#
# ggsave(s.sox.hm,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/SSW_S_SOX_Contigs_bySampDate_Depth_heatmap.png", width=15, height=10, dpi=600, create.dir=TRUE)
#
...
#   geom_tile(colour="white",size=0.25)  +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",na.value="grey50",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Assimilatory Sulfuate Reduction in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO, Grouped by Bin Assigment",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=15),
#         axis.text = element_text(size=15),axis.text.x = element_text(),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.border=element_blank(),panel.background = element_rect(fill = "white", colour = NA)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0)) + facet_grid(.~SampDate)
#
# ggsave(s.R.hm1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/SSW_S_AssSO4_Reduction_Contigs_bySampDate_Depth_heatmap.png", width=15, height=10, dpi=600, create.dir=TRUE)
#
...
#   geom_tile(colour="white",size=0.25)  +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",na.value="grey50",labels=c("0.9","0.55","0.2"),breaks=c(0.9,0.55,0.2)) + labs(title="Dissimilarity Sulfuate RedOx in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO, Grouped by Bin Assigment",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=15),
#         axis.text = element_text(size=15),axis.text.x = element_text(),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.border=element_blank(),panel.background = element_rect(fill = "white", colour = NA)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0)) + facet_grid(.~SampDate)
#
# ggsave(s.RO.hm1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/SSW_S_DissSO4_RedOx_Contigs_bySampDate_Depth_heatmap.png", width=15, height=10, dpi=600, create.dir=TRUE)
...
ggsave(soxy.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/SoxY_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(soxa.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/SoxA_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(soxd.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/SoxD_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(soxb.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/SoxB_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(sqr.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/sqr_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(fccB.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/fccB_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
#   xlab("Bin ID") + ylab("CLR-Transformed Coverage")
#
# ggsave(aprA.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/aprA_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(dsrB.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/dsrB_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(cysNC.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/CysNC_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(cysD.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/CysD_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(cysH.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/CysH_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
#   xlab("Bin ID") + ylab("CLR-Transformed Coverage")
#
# ggsave(sir.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/sir_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
#   xlab("Bin ID") + ylab("CLR-Transformed Coverage")
#
# ggsave(phsA.psrA.bin.fs,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/phsA.psrA_CLR_Coverage_BinID_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(soxy.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/SoxY_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(soxa.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/SoxA_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(soxd.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/SoxD_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(soxb.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/SoxB_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(sqr.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/sqr_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(fccB.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/fccB_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
#   xlab("Genus") + ylab("CLR-Transformed Coverage")
#
# ggsave(aprA.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/aprA_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(dsrB.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/dsrB_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(cysNC.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/CysNC_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(cysD.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/CysD_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
ggsave(cysH.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/CysH_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
#   xlab("Genus") + ylab("CLR-Transformed Coverage")
#
# ggsave(sir.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/sir_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
#   xlab("Genus") + ylab("CLR-Transformed Coverage")
#
# ggsave(phsA.psrA.bin.fs1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/FxnScatterplots/phsA.psrA_CLR_Coverage_Genus_fxn.sum.png", width=12, height=10, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))
#
# ggsave(sulf.bi.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_BinID_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(sulf.bi.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_BinID_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(sulf.bi.hm1b2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Genus_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(sulf.bi.hm1b3,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_HIMB30_Bins_Only_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(sulf.bi.hm1b3,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Genus_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathwaySpecific~SampDate, scales="free", space = "free")
#
# ggsave(sulf.bi.hm1c2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Bins_BinID_by_Function_SampDate_PathwaySpecific_Binary_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathwaySpecific~SampDate, scales="free", space = "free")
#
# ggsave(sulf.bi.hm1c3,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Bins_Genus_by_Function_SampDate_PathwaySpecific_Binary_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
#
...
#
# ggsave(sulf.bi.hm1c4,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_HIMB30_Bins_Only_by_Function_PathwaySpecific_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate,scales="free_x", space = "free")
#
# ggsave(sulf.bi.hm1d,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_BinID_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate,scales="free_x", space = "free")
#
# ggsave(sulf.bi.hm1d2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Genus_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
#
...
#
# ggsave(sulf.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_BinID_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~SampDate, scales="free", space = "free")
#
# ggsave(sulf.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Genus_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~SampDate, scales="free", space = "free")
#
# ggsave(sulf.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
#
...
# #   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
# #
# # ggsave(sulf.bi.hm1e0,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_Bins_Pathways_Binary_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
# #
...
# #   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
# #
# # ggsave(sulf.bi.hm1e5,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_Bins_Pathways_Binary_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
# #
...
# #   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
# #
# # ggsave(sulf.bi.hm1e6,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Sulfur/PresenceAbsence/Sulfur_KOFxns_Bins_Pathways_Binary_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
#
...
nitro.hm1a<-ggplot(clr.nitro.all.bin, aes(PlotBin, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.4","0.2","0.1"),breaks=c(0.4,0.2,0.1)) + labs(title="Nitrogen Metabolism in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(nitro.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_BinID_by_Function_heatmap.png", width=18, height=13, dpi=600, create.dir=TRUE)
...
ggsave(nitro.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_BinID_by_Function_Pathway_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(nitro.hm1c,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_SampDate_Depth_by_Function_Pathway_heatmap.png", width=15, height=18, dpi=600, create.dir=TRUE)
...
ggsave(nitro.hm1d,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_Depth_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
...
ggsave(nitro.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Depth_m~SampDate,scales="free", space = "free")
#
# ggsave(nitro.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_heatmap1d.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_wrap(.~SampDate)
#
# ggsave(nitro.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_MGMs_heatmap1d.png", width=18, height=18, dpi=600, create.dir=TRUE)

nitro.hm1e<-ggplot(clr.nitro.all.bin[clr.nitro.all.bin$Depth_m==0,], aes(PathShort, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.4","0.2","0.1"),breaks=c(0.4,0.2,0.1)) + labs(title="Nitrogen Metabolism in Salton Seawater MAGs - 0m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.x = element_text(size = 11,face="bold")) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(nitro.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_Pathways_MGMs_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)

# nitro.hm1f<-ggplot(clr.nitro.all.bin[clr.nitro.all.bin$Depth_m==5,], aes(PathShort, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.4","0.2","0.1"),breaks=c(0.4,0.2,0.1)) + labs(title="Nitrogen Metabolism in Salton Seawater MAGs - 5m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(nitro.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_Pathways_MGMs_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)

nitro.hm1g<-ggplot(clr.nitro.all.bin[clr.nitro.all.bin$Depth_m==10,], aes(PathShort, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.4","0.2","0.1"),breaks=c(0.4,0.2,0.1)) + labs(title="Nitrogen Metabolism in Salton Seawater MAGs - 10m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(nitro.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/Nitrogen_KOFxns_Pathways_MGMs_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))
#
# ggsave(nitro.bi.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_BinID_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(nitro.bi.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_BinID_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")
#
# ggsave(nitro.bi.hm1b2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_Genus_by_Function_Pathway_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate,scales="free_x", space = "free")
#
# ggsave(nitro.bi.hm1d,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_BinID_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate,scales="free_x", space = "free")
#
# ggsave(nitro.bi.hm1d2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_Genus_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~SampDate, scales="free", space = "free")
#
# ggsave(nitro.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_BinID_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~SampDate, scales="free", space = "free")
#
# ggsave(nitro.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_Genus_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~SampDate, scales="free", space = "free")
#
# ggsave(nitro.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_MGMs_Depth_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
# #
...
# #   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
# #
# # ggsave(nitro.bi.hm1e0,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_Bins_Pathways_Binary_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
# #
...
# #   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
# #
# # ggsave(nitro.bi.hm1e5,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_Bins_Pathways_Binary_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
# #
...
# #   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
# #
# # ggsave(nitro.bi.hm1e6,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Nitrogen/PresenceAbsence/Nitrogen_KOFxns_Bins_Pathways_Binary_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
#
...
carb.hm1a<-ggplot(clr.carb.all.bin, aes(PlotBin, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.8","0.45","0.1"),breaks=c(0.8,0.45,0.1)) + labs(title="Carbon Fixation in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(carb.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_MGMs_BinID_by_Function_heatmap.png", width=18, height=16, dpi=600, create.dir=TRUE)
...
ggsave(carb.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Bins_BinID_by_Function_Pathway_heatmap.png", width=22, height=20, dpi=600, create.dir=TRUE)

carb.hm1b1<-ggplot(clr.carb.all.bin, aes(Genus, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.15) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.8","0.45","0.1"),breaks=c(0.8,0.45,0.1)) + labs(title="Carbon Fixation in Salton Seawater MAGs by Genus",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.y = element_text(size = 11,face="bold")) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(PathShort~.,scales="free_y", space = "free")

ggsave(carb.hm1b1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Bins_Genus_by_Function_Pathway_heatmap.png", width=22, height=20, dpi=600, create.dir=TRUE)
...
ggsave(carb.hm1d,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Bins_BinID_by_Function_SampDate_Pathway_best_heatmap.png", width=24, height=20, dpi=600, create.dir=TRUE)
...
ggsave(carb.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_MGMs_Bins_Genus_by_Function_SampDate_Pathway_best_heatmap.png", width=24, height=20, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Depth_m~SampDate,scales="free", space = "free")
#
# ggsave(carb.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_MGMs_heatmap1d.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_wrap(.~SampDate)
#
# ggsave(carb.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_MGMs_heatmap1d.png", width=18, height=18, dpi=600, create.dir=TRUE)

carb.hm1e<-ggplot(clr.carb.all.bin[clr.carb.all.bin$Depth_m==0,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.8","0.45","0.1"),breaks=c(0.8,0.45,0.1)) + labs(title="Carbon Fixation in Salton Seawater MAGs - 0m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.x = element_text(size = 11,face="bold")) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(carb.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_Bins_Pathways_MGMs_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)

carb.hm1f<-ggplot(clr.carb.all.bin[clr.carb.all.bin$Depth_m==5,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.8","0.45","0.1"),breaks=c(0.8,0.45,0.1)) + labs(title="Carbon Fixation in Salton Seawater MAGs - 5m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(carb.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_Bins_Pathways_MGMs_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)

carb.hm1g<-ggplot(clr.carb.all.bin[clr.carb.all.bin$Depth_m==10,], aes(Pathway, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.8","0.45","0.1"),breaks=c(0.8,0.45,0.1)) + labs(title="Carbon Fixation in Salton Seawater MAGs - 10m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(carb.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/Carbon_KOFxns_Bins_Pathways_MGMs_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
...
ggsave(carb.bi.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_BinID_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600, create.dir=TRUE)
...
ggsave(carb.bi.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_BinID_by_Function_Pathway_Binary_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(carb.bi.hm1b2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_Genus_by_Function_Pathway_Binary_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(carb.bi.hm1d,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_BinID_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(carb.bi.hm1d2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_Genus_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(carb.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_BinID_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=22, height=20, dpi=600, create.dir=TRUE)
...
ggsave(carb.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_MGMs_Genus_by_Function_SampDate_Pathway_Binary_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
#
# ggsave(carb.bi.hm1e0,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_Bins_Pathways_Binary_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(carb.bi.hm1e5,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_Bins_Pathways_Binary_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(carb.bi.hm1e6,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Carbon/PresenceAbsence/Carbon_KOFxns_Bins_Pathways_Binary_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
...
# # first heat map of phototrophy KOs
#par(mar=c(1,1,1,1))
...
photo.hm1a<-ggplot(clr.photo.all.bin, aes(PlotBin, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.23","0.22","0.21"),breaks=c(0.23,0.22,0.21)) + labs(title="Phototrophy Metabolism in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(photo.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_BinID_by_Function_heatmap.png", width=18, height=13, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1a2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_BinID_by_Function_Phototrophy_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1a3,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_BinID_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1a4,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_BinID_by_Function_Phototrophy_System_heatmap2.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1a5,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_BinID_by_Function_SampDate_Phototrophy_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1a6,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_BinID_by_Function_SampDate_Phototrophy_System_best_heatmap2.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Genus_by_Function_heatmap.png", width=18, height=13, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1b2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Genus_by_Function_Phototrophy_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1b3,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Genus_by_Function_SampDate_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1b4,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Genus_by_Function_Phototrophy_System_heatmap2.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1b5,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Genus_by_Function_SampDate_Phototrophy_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.hm1b6,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_MGMs_Genus_by_Function_SampDate_Phototrophy_System_best_heatmap2.png", width=20, height=15, dpi=600, create.dir=TRUE)

photo.hm1e<-ggplot(clr.photo.all.bin[clr.photo.all.bin$Genus==0,], aes(Phototrophy, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.23","0.22","0.21"),breaks=c(0.23,0.22,0.21)) + labs(title="Phototrophy Metabolism in Salton Seawater MAGs - 0m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.x = element_text(size = 11,face="bold")) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(photo.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_Phototrophys_MGMs_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)

photo.hm1f<-ggplot(clr.photo.all.bin[clr.photo.all.bin$Genus==5,], aes(Phototrophy, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.23","0.22","0.21"),breaks=c(0.23,0.22,0.21)) + labs(title="Phototrophy Metabolism in Salton Seawater MAGs - 5m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(photo.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_Phototrophys_MGMs_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)

photo.hm1g<-ggplot(clr.photo.all.bin[clr.photo.all.bin$Genus==10,], aes(Phototrophy, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.23","0.22","0.21"),breaks=c(0.23,0.22,0.21)) + labs(title="Phototrophy Metabolism in Salton Seawater MAGs - 10m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.4),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)

ggsave(photo.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/Phototrophy_KOFxns_Phototrophys_MGMs_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_System_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1c,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_Phototrophy_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1d,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_SampDate_System_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_by_Function_SampDate_Phototrophy_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1b2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Genus_by_Function_System_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1c2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Genus_by_Function_Phototrophy_Binary_heatmap.png", width=17, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1d2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Genus_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=13, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1e2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Genus_by_Function_SampDate_System_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
ggsave(photo.bi.hm1f2,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_MGMs_Genus_by_Function_SampDate_Phototrophy_Binary_best_heatmap.png", width=20, height=15, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
#
# ggsave(photo.bi.hm1e0,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_Phototrophys_Binary_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(photo.bi.hm1e5,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_Phototrophys_Binary_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(photo.bi.hm1e6,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Phototrophy/PresenceAbsence/Phototrophy_KOFxns_Phototrophys_Binary_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
...
# first heat map of aerobic respiration KOs
par(mar=c(1,1,1,1))
...
aero.hm1a<-ggplot(clr.aero.all.bin, aes(PlotBin, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.25) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.70","0.35","-0.1"),breaks=c(0.70,0.35,-0.1)) + labs(title="Aerobic Respiration in Salton Seawater MAGs",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.35),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))

ggsave(aero.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_BinID_by_Function_heatmap.png", width=18, height=16, dpi=600, create.dir=TRUE)
...
ggsave(aero.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Bins_BinID_by_Function_Enzyme_heatmap.png", width=22, height=20, dpi=600, create.dir=TRUE)
...
ggsave(aero.hm1c,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Bins_BinID_by_Function_SampDate_Enzyme_best_heatmap.png", width=24, height=20, dpi=600, create.dir=TRUE)

# by Genus
aero.hm1b1<-ggplot(clr.aero.all.bin, aes(Genus, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
  geom_tile(colour="white",size=0.15) +
  scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.70","0.35","-0.1"),breaks=c(0.70,0.35,-0.1)) + labs(title="Aerobic Respiration in Salton Seawater MAGs by Genus",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
  theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
        axis.text = element_text(size=15),axis.text.x = element_text(angle=45, hjust=1),legend.text = element_text(size=15),plot.title = element_text(size=22),
        axis.ticks=element_line(size=0.35),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.y = element_text(size = 11,face="bold")) +
  xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(EnzShort~.,scales="free_y", space = "free")

ggsave(aero.hm1b1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Bins_Genus_by_Function_Enzyme_heatmap.png", width=22, height=20, dpi=600, create.dir=TRUE)
...
ggsave(aero.hm1c1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_Bins_Genus_by_Function_SampDate_Enzyme_best_heatmap.png", width=24, height=20, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(Depth_m~SampDate,scales="free", space = "free")
#
# ggsave(aero.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_heatmap1d.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_wrap(.~SampDate)
#
# ggsave(aero.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_MGMs_heatmap1d.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
# aero.hm1e<-ggplot(clr.aero.all.bin[clr.aero.all.bin$Depth_m==0,], aes(Enzyme, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.70","0.35","-0.1"),breaks=c(0.70,0.35,-0.1)) + labs(title="Aerobic Respiration in Salton Seawater MAGs - 0m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.35),panel.grid = element_blank(),plot.subtitle=element_text(size=14),strip.text.x = element_text(size = 11,face="bold")) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(aero.hm1e,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_Bins_Enzymes_MGMs_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
# aero.hm1f<-ggplot(clr.aero.all.bin[clr.aero.all.bin$Depth_m==5,], aes(Enzyme, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.70","0.35","-0.1"),breaks=c(0.70,0.35,-0.1)) + labs(title="Aerobic Respiration in Salton Seawater MAGs - 5m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.35),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(aero.hm1f,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_Bins_Enzymes_MGMs_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
# aero.hm1g<-ggplot(clr.aero.all.bin[clr.aero.all.bin$Depth_m==10,], aes(Enzyme, KO_Function.KEGG, fill=CLR_SumCovPerKO)) +
#   geom_tile(colour="white",size=0.25) +
#   scale_fill_gradient(low="#5f03f8", high="#ffaf43",labels=c("0.70","0.35","-0.1"),breaks=c(0.70,0.35,-0.1)) + labs(title="Aerobic Respiration in Salton Seawater MAGs - 10m",subtitle="Using CLR-Transformed, Gene Coverage Summed by KO",fill="CLR Coverage Per KO") +
#   theme(axis.title.x = element_text(size=20),axis.title.y = element_text(size=20),legend.title.align=0.5, legend.title = element_text(size=18),
#         axis.text = element_text(size=15),axis.text.x = element_text(hjust=1,angle=45),legend.text = element_text(size=15),plot.title = element_text(size=22),
#         axis.ticks=element_line(size=0.35),panel.grid = element_blank(),plot.subtitle=element_text(size=14)) +
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(aero.hm1g,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/Aerobic_Respiration_KOFxns_Bins_Enzymes_MGMs_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
...
ggsave(aero.bi.hm1a,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_BinID_by_Function_Binary_heatmap.png", width=18, height=13, dpi=600, create.dir=TRUE)
...
ggsave(aero.bi.hm1b,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_BinID_by_Function_Enzyme_Binary_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(aero.bi.hm1c,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_BinID_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(aero.bi.hm1d,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_BinID_by_Function_SampDate_Enzyme_Binary_best_heatmap.png", width=22, height=20, dpi=600, create.dir=TRUE)
...
ggsave(aero.bi.hm1b1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Genus_by_Function_Enzyme_Binary_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(aero.bi.hm1c1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Genus_by_Function_SampDate_Binary_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
ggsave(aero.bi.hm1d1,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_MGMs_Genus_by_Function_SampDate_Enzyme_Binary_best_heatmap.png", width=20, height=20, dpi=600, create.dir=TRUE)
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(~SampDate)
#
# ggsave(aero.bi.hm1e0,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_Bins_Enzymes_Binary_0m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(aero.bi.hm1e5,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_Bins_Enzymes_Binary_5m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
#
...
#   xlab("") + ylab("") + scale_y_discrete(expand=c(0, 0))+scale_x_discrete(expand=c(0, 0))+ facet_grid(.~SampDate)
#
# ggsave(aero.bi.hm1e6,filename = "figures/Revised/MGM_Figs/BinsOnly/FxnDiv/Aerobic_Respiration/PresenceAbsence/Aerobic_Respiration_KOFxns_Bins_Enzymes_Binary_10m_heatmap.png", width=18, height=18, dpi=600, create.dir=TRUE)
...
png('figures/Revised/MGM_Figs/BinsOnly/FxnDiv/SSW_MAG_Bin_pcoa_CLR_SummedCoverage_perKO_betadispersion_sampledate.png',width = 700, height = 600, res=100)
plot(mgm.disper5,main = "Centroids and Dispersion based on Aitchison Distance (CLR Data)", col=colorset1$SampDate_Color)
dev.off()

png('figures/Revised/MGM_Figs/BinsOnly/FxnDiv/SSW_MAG_Bin_boxplot_CLR_SummedCoverage_perKO_centroid_distance_sampledate.png',width = 700, height = 600, res=100)
...
# Visualize dispersions
png('figures/Revised/MGM_Figs/BinsOnly/FxnDiv/ssw_MAG_Bin_pcoa_CLR_SummedCoverage_per_KO_betadispersion_depth.png',width = 700, height = 600, res=100)
plot(mgm.disper6,main = "Centroids and Dispersion based on Aitchison Distance (CLR Data)", col=colfunc(3))
dev.off()

png('figures/Revised/MGM_Figs/BinsOnly/FxnDiv/ssw_MAG_Bin_boxplot_CLR_SummedCoverage_per_KO_centroid_distance_depth.png',width = 700, height = 600, res=100)
