...
ggsave(b.gen_RAall,filename = "figures/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot.png", width=35, height=10, dpi=600)
...
ggsave(b.gen_RA0,filename = "figures/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_1perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA00,filename = "figures/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_2perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA1,filename = "figures/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_5perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA2,filename = "figures/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_10perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA3,filename = "figures/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_25perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RA4,filename = "figures/RelativeAbundance/Genus/SSW_16S_Genera.RA_barplot_35perc.png", width=12, height=10, dpi=600)
...
ggsave(b.gen_RAall,filename = "figures/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA.png", width=45, height=10, dpi=600)
...
ggsave(b.gen_RA0,filename = "figures/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_1perc_barplot.png", width=20, height=10, dpi=600)
...
ggsave(b.gen_RA00,filename = "figures/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_2perc_barplot.png", width=20, height=10, dpi=600)
...
ggsave(b.gen_RA1,filename = "figures/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_5perc_barplot.png", width=16, height=10, dpi=600)
...
ggsave(b.gen_RA2,filename = "figures/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_10perc_barplot.png", width=16, height=10, dpi=600)
...
ggsave(b.gen_RA3,filename = "figures/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_15perc_barplot.png", width=16, height=10, dpi=600)
...
ggsave(b.gen_RA4,filename = "figures/RelativeAbundance/GenusSpecies/SSW_16S_Genera.Spec.RA_25perc_barplot.png", width=15, height=10, dpi=600)
...
ten.aug<-ggplot(b.genus_RA_meta2[b.genus_RA_meta2$SampDate=="August.2021",], aes(x=PlotID, y=Count, fill=Genus))+geom_bar(stat="identity",colour="black")+scale_y_continuous(expand = c(0, 0))+theme_classic()+
  labs(x=" ", y=" ",fill="Genus")+
  theme(axis.title.x = element_text(size=13),axis.title.y = element_text(size=13),axis.text = element_text(size=16),axis.text.x = element_text(hjust=1,angle=45,face="bold"),legend.title.align=0.5, legend.title = element_text(size=13),legend.text = element_text(size=11),plot.title = element_text(size=15))+
...
ggsave(ten.by.date,filename = "figures/RelativeAbundance/Genus/16S_MonthComparison_Top10Genera.RA_barplot_poster.png", width=25, height=12, dpi=600,bg="white")
...
ggsave(b.gen_RA00,filename = "figures/RelativeAbundance/Genus/August2021/SSW_16S_Genera.Spec.RA_barplot_2perc.png", width=12, height=10, dpi=600)
